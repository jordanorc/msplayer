...
public class ZoomTest {
	public static void main(String[] args) {
		ImagePanel panel = new ZoomTest.ImagePanel();
	...
	public static class ImagePanel extends JPanel {
		...
		private void loadImage() {
			String fileName = "/home/jordano/Downloads/google-recebera-multa-recorde-de-rr-3-bilhoes-na-europa-diz-jornal-britanico.jpg.png";
